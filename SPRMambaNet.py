...
class LSTContextLayer(nn.Module):
    def __init__(self,
                 dim: int,
...
class LSTContextBlock(nn.Module):
    """
    Args:
...
class SPRMamba(nn.Module):
    def __init__(self, args):
        super().__init__()

        self.stage1 = LSTContextBlock(num_layers=args.NUM_LAYERS,
        ...
        for s in range(1, args.NUM_STAGES):
            self.stages.append(
                LSTContextBlock(num_layers=args.NUM_LAYERS,
